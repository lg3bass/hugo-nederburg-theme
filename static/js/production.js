...
function enableTouchDropdown() {
    ...
    for (i = 0; i < a.length; i++) a[i].className = a[i].className + " closed", a[i].addEventListener("click", openDropdown)
}
...
function openDropdown(a) {
    hasClass(this, "closed") && (a.preventDefault(), this.className = this.className.replace("closed", ""))
}! function(a) {
    "use strict";
    ...
    function b() {
        var b = q.height();
        if (n.hasClass("toggled")) n.removeClass("toggled"), a(window).unbind("scroll"), setTimeout(function() {
            ...
            n.addClass("toggled"), t.css("min-height", b + 240), o.css("padding-top", u.height() + u.position().top), p.css("padding-top", a("#title-info").height() + 48), a(window).scroll(c)
        }
    }
    ...
    function e() {
        if (r.hasClass("secondary-toggle")) r.removeClass("secondary-toggle"), a("#main, #title-info, #toggle-navigation, #site-footer").css("transform", "translateY(0)"), r.css("height", "auto");
        else {
            r.addClass("secondary-toggle");
            var b = a("#menu-secondary-items").height() + 48;
            a("#main, #title-info, #toggle-navigation, #site-footer").css("transform", "translateY(" + b + "px)"), r.css("height", r.outerHeight() + b + "px")
        }
    }

    function f() {
        if (r.hasClass("search-open")) r.removeClass("search-open"), a("#search-icon").css("left", 0);
        else {
    ...
    function i() {
        a(".lazy").each(function() {
            var b = a(this).offset().top,
                ...
                d = a(window).height(),
                e = d > b - c - 100;
            e && (a(this).hasClass("lazy-image") && a(this).attr("src", a(this).attr("data-src")).removeClass("lazy-image"), a(this).hasClass("lazy-bg-image") && a(this).css("background-image", 'url("' + a(this).attr("data-background") + '")').removeClass("lazy-bg-image"))
        })
    }
    ...
    function m() {
        if (window.innerWidth > 899 && (r.hasClass("two-column") || r.hasClass("two-column-images"))) {
            a(".infinite-wrap").children(".excerpt").detach().appendTo(s), a(".infinite-wrap, .infinite-loader").remove();
            var b = s.find(".excerpt"),
                c = 1;
            b.each(function() {
                if (a(this).hasClass("sorted")) return void c++;
                if (a(this).addClass("sorted"), 2 == c && a(this).addClass("right"), c > 2) {
                    var b = a(this).prev(),
                        d = a(this).prev().prev(),
                        e = Math.ceil(b.offset().top + b.outerHeight()),
                        f = Math.ceil(d.offset().top + d.outerHeight());
                    if (b.hasClass("right")) var g = "right",
                        h = "left";
                    else var g = "left",
                        h = "right";
    ...
    var r = a("body"),
        ...
        u = a("#title-info");
    d(), h(), i(), j(), k(), l(), a(window).load(function() {
        m(), g()
    }), a(window).on("resize", function() {
        g(), k(), m(), window.innerWidth > 799 && a("#site-header").hasClass("toggled") && b()
    ...
    }), a("#toggle-navigation").bind("click", b), a(".menu-item a, .page_item a").focus(function() {
    ...
    }), a("#toggle-secondary-navigation").bind("click", e), a("#search-icon").bind("click", f);
    var v = {
        allow: !0,
        reallow: function() {
            v.allow = !0
...
var hasTouch;
window.addEventListener("touchstart", setHasTouch, !1), window.addEventListener("hashchange", function() {
